...
def check(problem,answer):
 ...
 correct_txt ='Correct:'+str(len(right)) +'('+", ".join(str(i) for i in right)+')'
 wrong_txt ='Wrong:' + str(len(wrong)) + '(' + ", ".join(str(i) for i in wrong) + ')'
...
def load(path):
    try:
        ...
        for i in load_txt:
            ...
            change.append(input_pro)
        return change
>>>>>>> 74833e427231b89983a536f890400f66c7dc0438
